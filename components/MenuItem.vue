<template>
    <li class="w-fit md:w-full cursor-pointer p-2 md:p-3 hover:bg-[var(--tertiary-color)] rounded-lg" :class="{ 'bg-[var(--tertiary-color)]': isActive(), 'bg-[var(--secondary-color)]': !isActive() }">
